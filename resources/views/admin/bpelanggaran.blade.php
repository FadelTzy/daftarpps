                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                @if (Auth::user()->role == 1)
                                <h4>Manajemen Data Batas Pelanggaran</h4>
                                    @else
                                    <h4> Data Batas Pelanggaran</h4>
                                ...
                                <div class="section-header-button">
                                    @if (Auth::user()->role == 1)
                                        <button data-toggle="modal" data-target="#exampleModal"
                                            href="features-post-create.html" class="btn btn-primary">Tambah</button>
                                    @endif
                                </div>
                            </div>
                        ...
                        <form id="dataperiode" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="Nama">Batas Poin</label>

                                    <div class="input-group">

                                        <input type="number" name="poin" placeholder="Input poin "
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="sanksi" placeholder="Input sanksi"
                                            class="form-control phone-number">
                                    </div>
                                    <br>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="poinu" name="poin" placeholder="Input poin "
                                        class="form-control phone-number">
                                </div>
                                <br>
                                <label for="Nama">Sanksi Pelanggaran</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" id="sanksiu" name="sanksi" placeholder="Input sanksi"
                                        class="form-control phone-number">
                                </div>
                                <br>
                            </div>
    ...
    <script>
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-bataspelanggaran/' + id,
                    type: "delete",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
