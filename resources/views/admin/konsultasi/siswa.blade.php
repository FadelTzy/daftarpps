...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Data Konsultasi Siswa {{ $user->name }} | {{ $user->username }}
            </h1>
        </div>
                            ...
                            <div class="card-body">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb bg-primary text-white-all">
                                        <li class="breadcrumb-item"><a href="#"><i class="fas fa-book"></i>Nama :
                                                {{ $user->name }}</a></li>
                                    </ol>
                                </nav>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <h4>Manajemen Data Konsultasi Siswa</h4>
                                ...
                                <div class="section-header-button">
                                    ...
                                    @else
                                        <button data-toggle="modal" data-target="#exampleModal"
                                            href="features-post-create.html" class="btn btn-primary">Konsul</button>
                                    @endif

                                    @if (Auth::user()->role == 2)
                                    @else
                                        <a href="{{ route('konsul.index') }}" class="btn btn-success">Kembali</a>
                                    @endif
                                </div>
                            </div>
                        ...
                        <form id="dataperiode" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="idguru" value="{{ $user->id_guru }}">
                                    <input type="hidden" name="iduser" value="{{ $user->id }}">
                                    <label for="Nama">Judul Konsultasi</label>
                                    <div class="input-group">
                                        <select class="form-control phone-number" name="judul" id="judul">
                                    ...
                                    <div class="input-group">
                                        <textarea name="pesan" style="height: 200px" class="form-control" cols="30" rows="10"></textarea>
                                    </div>
                                    <br>
