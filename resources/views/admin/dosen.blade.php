...
@section('content')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nis" placeholder="Input nip"
                                            class="form-control phone-number">
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="nomor" placeholder="Input No"
                                         ...
                                         <br>
                                    <label for="Nama">Guru BK</label>

                                    <div class="input-group">
                                       <select name="bk" class="form-control" id="">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="wali" placeholder="Input Wali"
                                            class="form-control phone-number">
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="pekerjaan" placeholder="Input Pekerjaan"
                                            class="form-control phone-number">
                                    </div>
                                    <br>
                                    ...
                                    <br>
                                    <label for="Nama">Nomor Wali</label>

                                    <div class="input-group">

                                        <input type="text" name="nowali" placeholder="Input Nomor"
                                            class="form-control phone-number">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nipu" name="nis" placeholder="Input nip"
                                        class="form-control phone-number">
                                </div>
                                <br>
                                <label for="Nama">Kelas</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="kelasu" name="kelas" placeholder="Input Kelas"
                                        class="form-control phone-number">
                                </div>
                                <br>
                                ...
                                <br>
                                    ...
                                    <div class="input-group">
                                       <select name="bk" class="form-control" id="bku">
                                        <option selected disabled>Pilih Guru BK</option>
                                        @foreach ($guru as $item)
                                            <option value="{{$item->id}}">{{$item->name}}</option>
                                        @endforeach
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="rpqs">
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Riwayat Pengerjaan Quiz Siswa</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="trpqs">
                            <thead>
                                <tr>
                                    <th class="text-center pt-2">
                                        no
...
@push('js')
    ...
    <script>
        ...
        function liharriwayat(id) {
            $("#rpqs").modal('show');
            if ($.fn.DataTable.isDataTable("#trpqs")) {
                $('#trpqs').DataTable().clear().destroy();
            }
            tabell = $("#trpqs").DataTable({
                columnDefs: [{
                        targets: 0,
                        width: "1%",
                    },
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/data-siswa/riwayat-quiz') }}" + '/' + id,
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
