...
@section('content')
        ...
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Topik</h5>
                        ...
                        <form id="dataperiode" method="POST">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="Nama">Topik Konsultasi</label>
                                    <div class="input-group">

                                        <input type="text" name="topik" placeholder="Input topik"
                                            class="form-control">
                                    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="up">
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Topik</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="dataperiodeu" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="topiku">Topik Konsultasi</label>
                                <div class="input-group">

                                    <input type="text" id="topiku" name="topik" placeholder="Input topik"
