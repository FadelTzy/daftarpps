...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Data Sanksi Siswa {{ $user->name }} | Nis : {{ $user->username }}
            </h1>
        </div>
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                ...
                                <h4>Sanksi Ku</h4>
                                    ...
                                    @else
                                <h4>Manajemen Data Sanksi Siswa</h4>
                                @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="jenis" placeholder="Input jenis"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="poin" placeholder="Input poin pelanggaran"
                                            class="form-control phone-number">
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tindaklanjut" placeholder="Input penanganan"
                                            class="form-control phone-number">
                                    </div>

                                    <br>
                                    <label for="Nama">Level Pelanggaran</label>

                                    <div class="input-group">
                                        <select name="level" class="form-control" id="">
                                            <option selected disabled>Pilih Level Pelanggaran</option>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            tabel = $("#dt").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: url + '/admin/data-sanksi/' + '{{ Request::segment(3) }}',
                },
                columns: [{
                        nama: 'DT_RowIndex',
                        data: 'DT_RowIndex'
        ...
        function staffdel(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/data-sanksi/verif/' + id,
                    type: "post",
                    success: function(e) {
                        $.LoadingOverlay("hide");
                        if (e == 'success') {
