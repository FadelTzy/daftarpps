                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bank" placeholder="Input "
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="c_bank" placeholder="Input "
                                            class="form-control phone-number">
                                    </div>
                                    <br>
        ...
        jQuery(document).ready(function() {
            ...
            tabel = $("#dt").DataTable({
                ...
                columns: [{
                        ...
                        nama: 'nama',
                        data: function (d) {
                            return d['bank'] + ' ' + d['c_bank'];
                        }
                    },
                    {
                        nama: 'nim',
                        data: function (d) {
                            return d['fak'] + ' ' + d['c_fak'];
                        }
                    },
                    {
                        name: 'aksi',
