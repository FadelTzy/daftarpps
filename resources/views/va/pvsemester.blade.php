...
@section('title')
    Buka Tutup Periode Semester
@endsection
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Buka Tutup Data Periode Semester
            </h1>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="float-left">
                                <h4>Manajemen Data Periode Semester</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="dt">
                                    <thead>
                                        <tr>
                                            <th class="text-center pt-2">Kode</th>
                                            <th>Semester </th>
                                            <th>Status</th>
                                            <th>Aksi</th>
                                        </tr>
