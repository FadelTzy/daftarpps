...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1> Data Tagihan Mahasiswa Periode {{ $dperiode->nama_semester }} | Gel :{{ $dgel->kodegel }}
            </h1>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="GET" action="{{ route('pvgelombang.index', [$periode, $gel]) }}" class="mt-4">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="status_pembayaran">Status Pembayaran</label>
                                        <select class="form-control" name="statusbayarform" id="statusbayarform">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control" name="statustagihanform" id="statustagihanform">
                                            <option selected disabled>Semua</option>
                            ...
                            <div class="float-right">
                                <div class="section-header-button">
                                    ...
                                    <button data-toggle="modal" data-target="#exampleModalIm"
                                        href="features-post-create.html" class="btn btn-primary">Unduh Tmplate</button>

                                    <button data-toggle="modal" data-target="#exampleModalIm"
                                        href="features-post-create.html" class="btn btn-primary">Import Data</button>
                                    ...
                                    <button onclick="inquiryall('{{ $datava }}')" class="btn btn-primary">Inquiry
                                        All</button>
                                    <a href="{{ route('pvpembayaran.index') }}" class="btn btn-primary">Kembali</a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="va"
                                            value="{{ '$va' ?? ('95941' . '$nim' ?? '$no') }}" placeholder="Input Nama"
                                            class="form-control">
                                    </div>
                                    <br>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="ref" value="{{ '$nim' ?? '$nodaftar' }}"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="jenjang"
                                                    placeholder="Input Jenjang (S2, S3 etc)" value="{{ '$jenjang' }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select name="semester" class="form-control" id="">
                                            ...
                                            @foreach ($allperiode as $item)
                                                ...
                                                @else
                                                    <option disabled value="{{ $item->kode_semester }}">
                                                        {{ $item->nama_semester }}
                                                        {{ $item->kode_semester }}</option>
                                                @endif
                                            @endforeach
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="gel" readonly value="{{ Request::segment(4) }}"
                                            placeholder="Input export" class="form-control">
                                    </div>
    ...
    <script>
        ...
        jQuery(document).ready(function() {
            ...
            tabel = $("#dt").DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('pvgelombang.index', [$periode, $gel]) }}",
                    data: function(d) {
                        d.statusbayarform = $('#statusbayarform').val();
                        d.statustagihanform = $('#statustagihanform').val();
                    }
                },
                columns: [{
                        nama: 'DT_RowIndex',
        ...
        $('#statusbayarform, #statustagihanform').change(function() {
            tabel.draw();
        });
